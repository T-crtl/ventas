...
SECRET_KEY = 'django-insecure-jw2+zu@cl^smc2%(+d%8w!v_^*hth0&d((jcn$e8y=o*x!e+lh'
...
INSTALLED_APPS = [
    ...
    'modulo_ventas.apps.ModuloVentasConfig',
]
...
EMAIL_HOST_PASSWORD = ''  # Tu contraseña de correo